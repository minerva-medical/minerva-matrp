...
/** validates the dispense lab test supply form */
...
/** Renders the Page for Dispensing Lab/Testing Supply. */
const DispenseLabTestSupplies = ({ currentUser, ready, sites, supplys }) => {
  ...
  if (ready) {
    return (
      <Tab.Pane id='dispense-form'>
        <Header as="h2">
          <Header.Content>
            Dispense from Lab Test Supplies Inventory Form
            <Header.Subheader>
...
DispenseLabTestSupplies.propTypes = {
