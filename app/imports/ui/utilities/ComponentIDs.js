export const COMPONENT_IDS = {
  ...
  GENERATE_ROLE_ADMIN: 'generate-role-admin',
  GENERATE_ROLE_USER: 'generate-role-user',
  GENERATE_FORM_EMAIL: 'generate-form-email',
  GENERATE_FORM_PASSWORD: 'generate-form-password',
  GENERATE_FORM_SUBMIT: 'generate-form-submit',
  ...
  ADD_VACCINATION_VACCINE: 'add-vaccination-vaccine',
  ...
  ADD_VACCINATION_DONATED_INPUT: 'add-vaccination-donated-input',
  ...
  ADD_VACCINATION_MIN_QUANTITY: 'add-vaccination-min-quantity',
  ...
  DISPENSE_SUP_SITE: 'dispense-sup-site',
  DISPENSE_SUP_NAME: 'dispense-sup-name',
  DISPENSE_SUP_LOCATION: 'dispense-sup-location',
  DISPENSE_SUP_DONATED: 'dispense-sup-donated',
  DISPENSE_SUP_DONATED_INPUT: 'dispense-sup-input',
  DISPENSE_SUP_NOTES: 'dispense-sup-notes',
  NAVBAR_MANAGE_DROPDOWN_USERS: 'navbar-manage-dropdown-users',
  ADD_SUPPLY_NAME: 'add-supply-name',
  ADD_SUPPLY_TYPE: 'add-supply-type',
  ADD_SUPPLY_MIN_QUANTITY: 'add-supply-min-quantity',
  ADD_SUPPLY_QUANTITY: 'add-supply-quantity',
  ADD_SUPPLY_LOCATION: 'add-supply-location',
